      ...
      <div className="onboarding-container">
        ...
        <div className="px-6 mb-8 onboarding-wrapper">
          <div className="flex gap-2 max-w-2xl">
            {[1, 2, 3].map((s) => (
              <div key={s} className={`h-1.5 flex-1 rounded-full transition-all duration-300 ${s <= step ? "bg-emerald-500" :
          ...
          {step === 1 && (
            <div className="space-y-6">
              ...
              <Input label="Age" type="number" className="max-w-2xl"
                value={formData.age} onChange={(v) => updateField('age', v)} placeholder="Enter your age"
          ...
          {step === 2 && (
            <div className="space-y-6 onboarding-wrapper">
              ...
              <div className="flex flex-col gap-4 max-w-2xl">
                ...
                <Input label="Height (cm) - Optional" type="number" value={formData.height}
            ...
            <div className="space-y-6 onboarding-wrapper">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm"> We will tailor your experience</p>
                </div>
              </div>
              ...
              <div className="space-y-4 max-w-lg">
                {goalOptions.map((option)=>(
                  ...
                  onClick={()=>{
                    ...
                    const range = ageRanges.find((r)=>age <= r.max) || 
              ...
              <div className = "space-y-8 max-w-lg">
                <h3 className = "text-md font-medium text-white mb-4">
                  ...
                  value ={formData.dailyCalorieIntake} onChange={(v)=>updateField('dailyCalorieIntake', v)} unit= "kcal" 
                  infoText="The total calories you plan to consume each day."/>

                  <Slider label= "Daily Calorie Burn" min={100} max={2000} step={50}
                  value ={formData.dailyCalorieBurn} onChange={(v)=>updateField('dailyCalorieBurn', v)} unit= "kcal" 
